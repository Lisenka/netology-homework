...
#!/bin/bash
cd /var/www/html
echo '<html><head><title>Lisenka</title></head> <body><h1>The best animal in the nature</h1><img src="http://${yandex_storage_bucket.yakunichkina.bucket_domain_name}/fox.jpg"/></body></html>' > index.html
EOF
    }
  }
