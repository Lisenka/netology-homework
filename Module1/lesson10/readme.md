...
### Ответ:
1. При системных вызовах, когда программа обращается к устройствам.
2. В случае аппаратных прерываний. Устройство сигнализирует об окончании действия или об ошибке.
